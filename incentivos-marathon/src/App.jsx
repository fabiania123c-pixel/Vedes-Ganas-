...
const TNA_CLUSTER = {
  "JEFE DE ALMACEN": {
    "MARATHON SPORTS": {
      A:[[0,0],[0.9,0.001],[0.9501,0.0022],[1,0.0032],[1.1,0.0042],[1.3,0.0052]],
      B:[[0,0],[0.9,0.002],[0.9501,0.003],[1,0.004],[1.1,0.005],[1.3,0.006]],
      C:[[0,0],[0.9,0.003],[0.9501,0.004],[1,0.005],[1.1,0.006],[1.3,0.007]],
    },
    "EXPLORER": {
  ...
  "SUBJEFE DE ALMACEN": {
    "MARATHON SPORTS": {
      A:[[0,0],[0.9,0.0008],[0.9501,0.00176],[1,0.00256],[1.1,0.00336],[1.3,0.00416]],
      B:[[0,0],[0.9,0.0016],[0.9501,0.0024],[1,0.0032],[1.1,0.004],[1.3,0.0048]],
      C:[[0,0],[0.9,0.0024],[0.9501,0.0032],[1,0.004],[1.1,0.0048],[1.3,0.0056]],
    },
    "EXPLORER": {
  ...
  "CAJERO": {
    "MARATHON SPORTS": {
      A:[[0,0],[0.9,0.00005],[0.9501,0.0001],[1,0.0004],[1.1,0.0005],[1.3,0.0007]],
      B:[[0,0],[0.9,0.0002],[0.9501,0.0003],[1,0.0005],[1.1,0.0007],[1.3,0.0009]],
      C:[[0,0],[0.9,0.0003],[0.9501,0.0004],[1,0.0006],[1.1,0.0008],[1.3,0.001]],
    },
    "EXPLORER": {
      A:[[0,0],[0.9,0.00005],[0.9501,0.0002],[1,0.0004],[1.1,0.0006],[1.3,0.0008]],
      B:[[0,0],[0.9,0.00007],[0.9501,0.0003],[1,0.0005],[1.1,0.0008],[1.3,0.0009]],
    },
  },
  "AUX. DE BODEGA": {
    "MARATHON SPORTS": {
...
const TNA_FLAT = {
  ...
  "CAJERO": {
    "OUTLET":[[0,0],[0.9,0.0001],[0.9501,0.0002],[1,0.0004],[1.1,0.0006],[1.3,0.0008]],
    "BODEGA DEPORTIVA":[[0,0],[0.9,0.0001],[0.9501,0.0002],[1,0.0004],[1.1,0.0006],[1.3,0.0008]],
    "TELESHOP":[[0,0],[0.9,0],[0.9501,0],[1,0],[1.1,0],[1.3,0]],
    "TAF":[[0,0],[0.9,0.00005],[0.9501,0.0002],[1,0.0004],[1.1,0.0006],[1.3,0.0008]],
    ...
    "CIKLA":[[0,0],[0.9,0],[0.9501,0],[1,0],[1.1,0],[1.3,0]],
    "BIG HEAD":[[0,0],[0.9,0.00005],[0.9501,0.0002],[1,0.0004],[1.1,0.0006],[1.3,0.0008]],
